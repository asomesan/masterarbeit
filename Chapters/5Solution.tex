...
Die Abbildungen \labelcref{fig:wireframe_start,fig:wireframe_results,fig:wireframe_detail_sp,fig:wireframe_catalogue} stellen die finalen Wireframes dar.
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=1.45\textwidth, angle=90]{Images/Mockup_Ergebnisseite_1}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=1.45\textwidth, angle=90]{Images/Mockup_Studie_Detailseite}
...
\begin{figure}[ht]
	\centering
    	\includegraphics[width=1.45\textwidth, angle=-90]{Images/Mockup_Studie_Detailseite_1}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=1.45\textwidth, angle=90]{Images/Mockup_Startseite_4}
   	\caption[Möglichkeiten für die Begriffsdefinition]{Möglichkeiten für die Begriffsdefinition entweder über die Unterseite \enquote{Catalog View} oder direkt über die Wortsuche}
   	\label{fig:point7_danach}
\end{figure}
...
Allerdings sollte die Anwendung nur die notwendigsten Elemente enthalten. 
...
Im Falle eines Fehlers soll Nutzer*innen klar gemacht werden, warum es zu diesem Fehler gekommen ist und wie dieser Fehler zu beheben ist.
Diese Heuristik entspricht der Eigenschaft \enquote{Fehlertolerant} aus der ISO-Norm 9241 \citep{ISO_standard}.
Zum Beispiel liefert ein gesuchter Begriff keine zutreffende Ergebnisse.
Demnach kann die Anwendung Nutzer*innen Feedback dazu geben und ihnen andere mögliche Suchbegriffe vorschlagen.
Siehe hier Abbildung \ref{fig:point9_danach}.
...
Hierfür sollen Nutzer*innen unter \enquote{About the project} im horizontalen Menü eine ausführliche Dokumentation zum Projekt und der Anwendung aufrufen können.
