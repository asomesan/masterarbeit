...
\begin{figure}[H]
	\centering
    	\includegraphics[width=\textwidth]{Images/Studie_Detailseite_1}
   	\caption{Lösung danach}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=\textwidth]{Images/Mockup_Startseite_3}
   	\caption{Suche mit Suchvorschläge}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=\textwidth]{Images/Mockup_Startseite_4}
   	\caption{Lösung danach}
   	\label{fig:wireframe_start}
\end{figure}
...
\begin{figure}[H]
	\centering
    	\includegraphics[width=\textwidth]{Images/Startseite}
   	\caption{Lösung davor}
