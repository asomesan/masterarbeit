...
% ****************************************************************************************************
\newcommand{\myTitle}{Optimierung der Navigation in einer Ontologie zur Beschreibung von Anwendungssystemen und Softwareprodukten im Gesundheitswesen\xspace}
\newcommand{\mySubtitle}{Mein Untertitel\xspace}
\newcommand{\myDegree}{DEGREE\xspace}
\newcommand{\myName}{Andreea-Maria Somesan\xspace}
\newcommand{\mybirthday}{10.09.1994}
\newcommand{\mybirthtown}{Sighisoara}
\newcommand{\mybirthcountry}{Rumänien}
...
\newcommand{\mySubject}{Informatik M. Sc.\xspace}
...
\newcommand{\myTime}{20.12.2022\xspace} 
